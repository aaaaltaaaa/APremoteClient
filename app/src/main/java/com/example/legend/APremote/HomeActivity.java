package com.example.legend.APremote;
...
import com.example.legend.APremote.control.AboutActivity;
import com.example.legend.APremote.control.BaseControlActivity;
import com.example.legend.APremote.control.FileDownloadActivity;
import com.example.legend.APremote.control.FileUploadActivity;
import com.example.legend.APremote.control.KeyBoardControlActivity;
...
public class HomeActivity extends BaseControlActivity {
    ...
    private CardView mAboutControl;
    ...
    protected void initView() {
        ...
        mAboutControl = findViewById(R.id.card_about);
    }
    ...
    protected void initListener() {
        ...
        mAboutControl.setOnClickListener(v -> startActivity(new Intent(HomeActivity.this, AboutActivity.class)));
    }
